CREATE TYPE "commits_status" AS ENUM ('pending', 'accepted', 'rejected');

CREATE TYPE "invitation_status" AS ENUM ('pending', 'accepted', 'rejected');

CREATE TYPE "user_universe_role" AS ENUM ('creator', 'super administrator', 'contributor');

CREATE TYPE "user_entity_role" AS ENUM ('entity administrator', 'editor', 'reader');
...
CREATE TABLE "text_blocks" (
    ...
    "created_at" timestamp NOT NULL DEFAULT 'now()',
    "updated_at" timestamp,
    CONSTRAINT unique_position_per_entity UNIQUE ("entity_id", "position")
);
